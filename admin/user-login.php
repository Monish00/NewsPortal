...
$sql =mysqli_query($con,"SELECT uName,EmailId,Mobile,Address,UserName,Password FROM tbluser WHERE (UserName='$uname' && Password ='$password')");
...
<h2 class="text-uppercase" style="color:#fff; text-align:center;">User Login</h2>
